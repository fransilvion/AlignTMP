...
import Alignment.ProbNeedlemanWunsch;
 ...
 */
public class PerformUPGMAforProbs {

    //////////////////////////////////////////////////////////////////////////
    //private constructor so no one can create a class
    private PerformUPGMAforProbs(){
    ...
    public static UPGMA calculateGuideTree(String[] ids, char[][] sequences,
                                           ArrayList<ProbNeedlemanWunsch> alignemnts) throws FileNotFoundException {
    ...
    private static double[][] buildDistMatrix(String[] ids, ArrayList<ProbNeedlemanWunsch> alignments){
    ...
    private static HashMap<Pair<String, String>, Double> getDistances(ArrayList<ProbNeedlemanWunsch> alignments){
        int i;
